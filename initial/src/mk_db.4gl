...
FUNCTION createTables()
	...
	CREATE TABLE menus(
			m_key SERIAL, m_name CHAR(8), m_text VARCHAR(50), m_type CHAR(1), m_child CHAR(8), m_cmd VARCHAR(50))
...
FUNCTION insertTestData()
	...
	CALL insMenu(0, "main", "Main Menu", "T", "", "")
	CALL insMenu(0, "main", "Maintenance Programs", "M", "maint", "")
	CALL insMenu(0, "maint", "Maintenance Programs", "T", "", "")
	CALL insMenu(0, "maint", "Menu Maintenance", "F", "", "fglrun menu_mnt")
	CALL insMenu(0, "maint", "Customer Maintenance", "F", "", "fglrun cust_mnt")
